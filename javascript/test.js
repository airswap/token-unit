...
// console.log(new TokenUnit(1000, 'ast').toString())
...
console.log(new TokenUnit(1, 'ether').to('ast')) // { amount: 0.1, name: 'picoether', unit: 'ether' }
console.log(new TokenUnit(1000, 'ast').to('ether')) // { amount: 0.1, name: 'picoether', unit: 'ether' }
console.log(new TokenUnit(10000000, 'air').to('ether')) // { amount: 0.1, name: 'picoether', unit: 'ether' }
